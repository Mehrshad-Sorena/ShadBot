...
def find_max_score(account_name):
	...
	for sym in symbols:
		...
		buy_path_primary = rsi_config.cfg['path_superhuman'] + 'primary' + path_slash + 'buy' + path_slash + sym.name + '.csv'
		buy_path_secondry = rsi_config.cfg['path_superhuman'] + 'secondry' + path_slash + 'buy' + path_slash + sym.name + '.csv'

		sell_path_primary = rsi_config.cfg['path_superhuman'] + 'primary' + path_slash + 'sell' + path_slash + sym.name + '.csv'
		sell_path_secondry = rsi_config.cfg['path_superhuman'] + 'secondry' + path_slash + 'sell' + path_slash + sym.name + '.csv'
...
def lot_checker(my_money,symbol,signal, account_name,risk_lot=0.02,levrage=100):
	...
	buy_path_primary = rsi_config.cfg['path_superhuman'] + 'primary' + path_slash + 'buy' + path_slash + symbol + '.csv'
	buy_path_secondry = rsi_config.cfg['path_superhuman'] + 'secondry' + path_slash + 'buy' + path_slash + symbol + '.csv'

	sell_path_primary = rsi_config.cfg['path_superhuman'] + 'primary' + path_slash + 'sell' + path_slash + symbol + '.csv'
	sell_path_secondry = rsi_config.cfg['path_superhuman'] + 'secondry' + path_slash + 'sell' + path_slash + symbol + '.csv'
...
def basket_manager_rsi_div(symbols,symbol,my_money,signal, account_name):
